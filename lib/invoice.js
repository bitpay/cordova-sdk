...
if ( typeof(EventSource) == 'undefined' ) {
  var EventSource = cordova.require('com.bitpay.sdk.cordova.EventSource');
}
...
BitpayInvoice.prototype.openWallet = function(params){
  ...
  var openWalletAndroid = function(){
    ...
    var intent = {
      ...
      url: self.data.paymentUrls[params.format]
     }

    var success = function(){}
    var fail = function(){
      console.log("Failed to open URL via Android Intent. URL: " + self.data.paymentUrls[params.format] )
    }
...
BitpayInvoice.prototype.subscribePaymentEvent = function(){
  ...
  self.pubclient.call( 'getInvoiceBusToken', { invoiceId: self.data.id }, openBusAndSubscribe );
