...
BitpayInvoice.prototype.openWallet = function(format, system){
  ...
  var openWalletAndroid = function(){
    ...
    var intent = {
      ...
      url: self.invoice.paymentUrls[format]
     }

    var success = function(){}
    var fail = function(){
      console.log("Failed to open URL via Android Intent. URL: " + self.invoice.paymentUrls[format] )
    }
  ...
  var openWalletBrowser = function(){
    ...
    iframe.src = self.invoice.paymentUrls[format];
